...
- **Map:** keyless Google Maps embed on the office coordinates `6.4707097,3.2524437`, supplied by the client 2026-08-20. The same figures appear in the `geo` block of the JSON-LD on `index.html` — change both together.
